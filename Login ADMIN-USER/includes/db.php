...
/**
 * includes/db.php
 * Koneksi MySQL Railway + auto-create tabel jika belum ada
 */
...
function getDB(): PDO {
    ...
    // Railway inject env vars ini secara otomatis
...
function _initTables(PDO $pdo): void {
    // Tabel users
    $pdo->exec("
